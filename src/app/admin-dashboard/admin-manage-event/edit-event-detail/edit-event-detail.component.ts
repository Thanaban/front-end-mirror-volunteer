...
constructor(private http:HttpClient,private eventService:EventService){}
  ...
  ngOnInit(): void {
    ...
    this.http.get<Event_show[]>('http://localhost:8000/activities/getoneid/'+(this.event.currentActivityId))
    .subscribe(response => {
  ...
  onSubmit(): void {
    ...
    this.eventService.update_activity(
      this.activityId,
      activity_name,
      time_detail,
      clothes_detail,
